// Constraint projection (structural): satisfy distance constraints.
// Each constraint: 3 floats (i, j, restLength). We read position, write position.
// Dispatch: 1D over numStructural.
...
@group(0) @binding(2) var<storage, read> constraints: array<vec3f>; // x=i, y=j, z=restLength
